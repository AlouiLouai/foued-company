...
export default function AboutPage() {
  ...
  const missionText = locale === 'fr' 
    ? "Notre MissionChez Renovexium, nous transformons vos espaces grâce ànotre savoir-faire exceptionnel et des solutions innovanteset durables. Notre équipe de professionnels certifiés vousassure une qualité irréprochable et un respect strict desdélais et du budget. Nous garantissons une communicationtransparente et des prix équitables, avec pour uniqueobjectif votre satisfaction client."
